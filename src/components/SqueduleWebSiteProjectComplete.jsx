  ...
  return (
    <div className="fixed top-0 left-0 z-10 w-full h-full bg-blue-600/90 flex flex-col items-center p-10 overflow-scroll">
      <h3 className="font-bold text-2xl">
        Pagina web Horario de Anime en Español + API REST
      </h3>
      <p>
        Esta página web desarrollada con Next.js que muestra un horario de anime
        en español. La página consume datos de una API REST propia y permite la
        actualizacion de los datos a través de un formulario .
      </p>
      <h4 className="font-bold text-2xl">Arquitectura</h4>
      <p>
        Backend : Con el metodo GET obtienes los datos de los animes y con el
        metodo POST en el formulario actualizas los animes de la nueva
        temporada.
      </p>
      <p>
